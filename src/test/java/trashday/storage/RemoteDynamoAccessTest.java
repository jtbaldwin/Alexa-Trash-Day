...
public class RemoteDynamoAccessTest extends DynamoAccessTestHelpers {
	/** Log object for this class */
    private static final Logger log = LoggerFactory.getLogger(RemoteDynamoAccessTest.class);
	 ...
	 */
    @ClassRule
    public static final RemoteDynamoDBCreationRule remoteDynamoDB = new RemoteDynamoDBCreationRule("TrashDayScheduleDataTest");
	...
	public static void setUpBeforeClass() {
		dynamoDbLowLevel = remoteDynamoDB.getAmazonDynamoDBClient();
		dynamoDbDocument = new DynamoDB(dynamoDbLowLevel);
		dynamoDbItemPersistence = remoteDynamoDB.getTrashDayDbClient();
		
		String serviceName = dynamoDbLowLevel.getServiceName();
		log.info("setUpBeforeClass: serviceName={}", serviceName);
		boolean isTestDynamoDB = remoteDynamoDB.isTestDB();
		...
		if (ctr!=null) {
	        ...
	        log.info("Existing Test Table Description: {}", tableDescription.toString());			
		}
	}
	...
	public void testCRUDCalendar() {
		LocalDateTime ldtRequest = LocalDateTime.of(2017, 2, 12, 9, 26);
