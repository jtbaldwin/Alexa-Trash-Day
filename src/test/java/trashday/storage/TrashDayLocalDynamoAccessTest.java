...
public class TrashDayLocalDynamoAccessTest {
	/** Log object for this class */
    private static final Logger log = LoggerFactory.getLogger(TrashDayLocalDynamoAccessTest.class);
	...
	public Integer itemCount(String customerId) {
        ...
        ScanResult scanResult = dynamoDB.getTrashDayDbClient().getAmazonDynamoDBClient().scan(scanRequest);
